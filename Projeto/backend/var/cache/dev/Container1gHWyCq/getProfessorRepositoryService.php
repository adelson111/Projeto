...
// Returns the private 'App\Repository\ProfessorRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProfessorRepository.php';

return $this->privates['App\\Repository\\ProfessorRepository'] = new \App\Repository\ProfessorRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

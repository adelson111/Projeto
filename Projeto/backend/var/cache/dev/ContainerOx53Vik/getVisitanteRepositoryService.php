...
// Returns the private 'App\Repository\VisitanteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/VisitanteRepository.php';

return $this->privates['App\\Repository\\VisitanteRepository'] = new \App\Repository\VisitanteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

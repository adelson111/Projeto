...
// Returns the private 'App\Repository\SugestaoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SugestaoRepository.php';

return $this->privates['App\\Repository\\SugestaoRepository'] = new \App\Repository\SugestaoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

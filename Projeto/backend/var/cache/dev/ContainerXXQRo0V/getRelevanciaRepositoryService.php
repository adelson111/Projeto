...
// Returns the private 'App\Repository\RelevanciaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\RelevanciaRepository.php';

return $this->privates['App\\Repository\\RelevanciaRepository'] = new \App\Repository\RelevanciaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

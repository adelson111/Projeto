...
// Returns the private 'App\Repository\ProjetoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ProjetoRepository.php';

return $this->privates['App\\Repository\\ProjetoRepository'] = new \App\Repository\ProjetoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
